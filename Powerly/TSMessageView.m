...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        self.titleLabel.textAlignment = isLanguageArabic ? NSTextAlignmentRight : NSTextAlignmentLeft;
        ...
        if ([subtitle length])
        {
            ...
            self.contentLabel.textAlignment = isLanguageArabic ? NSTextAlignmentRight : NSTextAlignmentLeft;
...
- (CGFloat)updateHeightOfMessageView
{
    ...
    if ([self.subtitle length])
    {
        ...
        self.contentLabel.frame = CGRectMake(self.contentLabel.frame.origin.x, self.contentLabel.frame.origin.y, screenWidth - padding - self.textSpaceLeft - self.textSpaceRight, self.contentLabel.frame.size.height);
